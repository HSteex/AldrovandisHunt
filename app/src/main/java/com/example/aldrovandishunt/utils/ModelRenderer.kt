package com.example.aldrovandishunt.utils
...
class ModelRenderer {
    ...
    fun onSurfaceAvailable(surfaceView: SurfaceView, lifecycle: Lifecycle, asset: String) {
        ...
        createRenderables(asset = asset)
    }

    private fun createRenderables(asset: String) {
        val buffer = assets.open("models/$asset.glb").use { input ->
